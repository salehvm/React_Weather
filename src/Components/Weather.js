...
const Weather = props => (
    <div className="weather__info">
        ...
        {props.lon && <p className="weather__key">Lon: <span className="weather__value">{props.lon}</span></p>}
        {props.lat && <p className="weather__key">Lon: <span className="weather__value">{props.lat}</span></p>}
